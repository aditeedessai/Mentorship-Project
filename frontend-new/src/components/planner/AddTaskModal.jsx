...
export default function AddTaskModal({ isOpen, onClose, onAddTask, defaultDate, studySets = [] }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
      <div
        className={`w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-3xl border p-5 sm:p-8 backdrop-blur-2xl shadow-2xl transition-all duration-300 ${isDarkMode
