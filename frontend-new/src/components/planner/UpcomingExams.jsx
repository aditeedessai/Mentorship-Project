...
import { Award, Clock, ArrowRight, BookOpen, Calculator, Atom, Brain, Plus, Trash2, Loader2, ChevronDown } from "lucide-react";
...
export default function UpcomingExams({ exams = [], studySets = [], onAddExamClick, onDeleteExam, onNavigate, isLoading = false }) {
  ...
  return (
    <>
      ...
      >
        {/* Header with Title, Collapse Toggle & Plus Add Button */}
        ...
        <div
          className={`transition-all duration-300 overflow-hidden ${
            isCollapsed ? "max-h-0 opacity-0 hidden" : "max-h-[2000px] opacity-100 mt-6"
          }`}
        >
          {/* Loading State */}
          {isLoading ? (
