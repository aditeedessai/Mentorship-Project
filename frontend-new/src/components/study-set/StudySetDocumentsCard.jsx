...
const getFileIcon = (fileName) => {
  if (!fileName) {
    return <File size={22} className="text-[#8064C7]" />;
  }
...
function StudySetDocumentsCard({
  documents = [],
  loading = false,
}) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex flex-col gap-3 p-5 border rounded-2xl backdrop-blur-xl relative overflow-hidden ${
          isDarkMode
      ...
      >
        ...
        {loading && (
          <div className="py-8 text-center">
            <Loader2
              size={30}
              className="mx-auto mb-2 animate-spin text-[#8064C7]"
            />
        ...
        {!loading && documents.length === 0 && (
          ...
          >
            ...
            >
              Upload study material to generate questions
              for this set.
            </p>
          </div>
        )}
