...
import jojoFlashcards from "../../assets/jojo-flashcards.png";
    ...
    >
      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            >
              Interactive study deck & memory practice
            </p>
          </div>
        </div>
      ...
      {(flashcardsLoading || flashcardsFetching) && (
        ...
        >
          ...
          <img
            src={jojoFlashcards}
            alt="Jojo preparing your flashcards"
            className="w-60 h-60 sm:w-65 sm:h-65 object-contain"
            style={{
          ...
          <p className="text-base font-bold mt-2">
            {flashcardsFetching
              ? "Jojo is checking your cards..."
              : "Jojo is creating your flashcards..."}
          </p>
          ...
          >
            {flashcardsFetching
              ...
              : "Jojo is turning important concepts from your study materials into quick memory cards."}
          </p>
        </div>
      )}
      ...
      {!flashcardsLoading &&
        !flashcardsFetching &&
        !flashcardsError &&
        (!flashcards || cardList.length === 0) && (
          <div
            className={`flex-1 flex flex-col lg:flex-row items-center gap-6 p-6 border rounded-2xl backdrop-blur-xl ${
              isDarkMode
                ? "border-white/10 bg-white/5"
                : "border-gray-200/80 bg-white/50"
            }`}
        ...
        !practiceMode && (
          ...
          >
            ...
            <div className="flex-1 text-left w-full">
              ...
              >
                {cardList.length} flashcards generated from your study
                material.
              </p>
      ...
      {!flashcardsLoading &&
        ...
        currentCard && (
          <div
            className={`flex-1 flex flex-col gap-6 p-6 border rounded-2xl backdrop-blur-xl ${
              isDarkMode
                ? "border-white/10 bg-white/5"
                : "border-gray-200/80 bg-white/50"
            }`}
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center">
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className={`px-3.5 py-1 rounded-full font-mono text-[11px] font-bold uppercase tracking-wider mb-3 flex items-center gap-1.5 ${
                        isDarkMode
                ...
                <div className="mb-6">
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: `${
                          ((currentCardIndex + 1) / cardList.length) * 100
                        }%`,
                      }}
                    />
                  </div>
