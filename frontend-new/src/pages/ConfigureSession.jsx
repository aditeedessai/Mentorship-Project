...
if (loading) {
  return (
    <div
      className={`flex min-h-[70vh] items-center justify-center rounded-3xl transition-all duration-500 ${isDarkMode
    ...
    >
      <div className="flex w-full max-w-xl flex-col items-center px-6 py-12 text-center">
        ...
        {/* INFORMATION CARD */}
        <div
          className={`mt-8 w-full max-w-sm rounded-2xl border px-5 py-4 backdrop-blur-xl ${isDarkMode
        ...
        >
          <div className="flex items-start gap-3 text-left">
            ...
            <p
              className={`text-xs font-semibold leading-relaxed ${isDarkMode
                  ? 'text-white/50'
                  : 'text-gray-500'
                }`}
            >
        ...
        {/* DON'T CLOSE */}
        <p
          className={`mt-5 text-[11px] ${isDarkMode
              ? 'text-white/30'
              : 'text-gray-400'
            }`}
        >
  ...
  <div className="flex h-full flex-col">
    ...
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="px-4 pb-6 pt-4 sm:px-8 sm:pb-6 sm:pt-8">
        ...
        {/* DESCRIPTION */}
        <p
          className={`mt-3 max-w-[600px] text-sm leading-relaxed ${isDarkMode
              ? 'text-white/60'
              : 'text-[#706A78]'
            }`}
        >
        ...
        <div className="relative mt-7">
          ...
          >
            ...
            {/* OUTER SOFT GLOW */}
            <div
              className={`configure-jojo-glow absolute inset-[20px] rounded-full blur-3xl ${isDarkMode
                  ? 'bg-[#8064C7]/25'
                  : 'bg-[#8064C7]/20'
                }`}
            />
            ...
            {/* STATIC OUTER RING */}
            <div
              className={`absolute inset-[8px] rounded-full border ${isDarkMode
                  ? 'border-white/10'
                  : 'border-[#8064C7]/15'
                }`}
            />
            ...
            {/* INNER DASHED ORBIT */}
            <div
              className={`absolute inset-[30px] rounded-full border border-dashed ${isDarkMode
                  ? 'border-white/15'
                  : 'border-[#8064C7]/20'
                }`}
            />
          ...
          <div className="flex flex-wrap gap-4">
            ...
            {questionTypes.map((type) => {
              ...
              const explanation =
                needsAttention
                  ? `${s.attempts_taken} attempt${s.attempts_taken === 1
                    ? ''
                    : 's'
