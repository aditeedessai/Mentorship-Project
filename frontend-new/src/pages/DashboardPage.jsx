...
function DashboardPage({ user, onNavigate }) {
  ...
  ======================================================= */
  useEffect(() => {
    const hasDashboard = !!document.querySelector('[data-tour="dashboard"]');
    const hasOverview = !!document.querySelector('[data-tour="dashboard-overview"]');
    console.log("[TOUR DEBUG] Dashboard mounted:", {
      hasDataTourDashboard: hasDashboard,
      hasDataTourOverview: hasOverview,
    });
  }, []);
  ...
  return (
    <>
      ...
      <div ref={dashboardRef} data-tour="dashboard-container">
        {/* =================================================
            GREETING BANNER
        ================================================= */}
        ...
        >
          {/* Legacy alias for dashboard overview */}
          <span data-tour="dashboard-overview" className="contents" />
