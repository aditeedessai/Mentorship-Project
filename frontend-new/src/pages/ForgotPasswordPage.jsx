      ...
      >
        ...
        <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-[#8064C7] via-[#7455B8] to-[#5D4298] p-12 text-white lg:flex">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-6 max-w-md text-sm leading-6 text-purple-100/90">
              No worries. Enter your registered email and we'll send you a reset code so Jojo can get you right back on track.
            </p>
          </div>
        ...
        <div className="p-4 sm:p-12 lg:p-14">
          ...
          <div className="mb-4 sm:mb-7">
            <h2 className="text-xl sm:text-3xl font-black tracking-tight">Reset your password</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            <div>
              <label className={`mb-1.5 sm:mb-2 block text-xs font-bold uppercase tracking-wider ${isDarkMode ? "text-white/70" : "text-[#292530]"}`}>
                Email Address
              </label>
              <input
                type="email"
                ...
                required
                className={`w-full rounded-xl border px-3.5 py-2.5 sm:px-4 sm:py-3 text-sm outline-none transition-all ${
                  isDarkMode
